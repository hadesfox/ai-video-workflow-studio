...
const Sidebar: React.FC<SidebarProps> = ({ currentStage, setStage, projectLoaded }) => {
  ...
  return (
    <div className="w-64 bg-theme-panel border-r border-theme-border flex flex-col h-full shrink-0">
      <div className="p-6 flex items-center space-x-2 border-b border-theme-border">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && <div className="ml-auto w-1.5 h-1.5 rounded-full bg-theme-accent shadow-[0_0_8px_rgba(96,165,250,0.6)]" />}
            </button>
          );
        })}
      </nav>
      ...
      <div className="p-4 border-t border-theme-border">
        <div className="bg-theme-card rounded-lg p-3">
          <p className="text-xs text-theme-secondary mb-1">当前项目</p>
